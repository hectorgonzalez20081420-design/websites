...
The name Shizuku comes from [pre+-Pie](https://danbooru.donmai.us/posts/3553474).
...
1. Execute `su`
2. Execute `pm ejecutar programa nativo`
3. (pre-Pie) Start the Java process with app_process ([su](https://android.googlesource.com/platform/frameworks/base/+/oreo-release/cmds/pm/pm))
4. (Pie+) Execute the native program `cmd` ([api](https://android.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
